...
RUN_NAME = "fable5_wikitext_mixed_smoke"
OLLAMA_MODEL_NAME = "kitai-fable5-wikitext"
...
def main() -> None:
    ...
    config = project_dir / "configs" / "fable5_wikitext_mixed_smoke.yaml"
    export_dir = project_dir / "exports" / "kitai_fable5_wikitext_hf"
    gguf_path = project_dir / "exports" / "kitai_fable5_wikitext_f16.gguf"
    modelfile_path = project_dir / "exports" / "Modelfile.kitai_fable5_wikitext"
    ...
    append_status(status_path, "Training process exited; checking for a new final checkpoint")
